...
PRODUCT_COPY_FILES += \
    ...
    $(DOLBY_PATH)/proprietary/vendor/lib64/hw/vendor.dolby.hardware.dms@2.0-impl.so:$(TARGET_COPY_OUT_VENDOR)/lib64/hw/vendor.dolby.hardware.dms@2.0-impl.so \
    ...
    $(DOLBY_PATH)/proprietary/vendor/etc/aualgo/aualgo_sst.conf:$(TARGET_COPY_OUT_VENDOR)/etc/aualgo/aualgo_sst.conf \
    $(DOLBY_PATH)/proprietary/vendor/etc/aualgo/aualgo_sst.dat:$(TARGET_COPY_OUT_VENDOR)/etc/aualgo/aualgo_sst.dat \
    $(DOLBY_PATH)/proprietary/vendor/lib/libaualgo_foundation.so:$(TARGET_COPY_OUT_VENDOR)/lib/libaualgo_foundation.so \
    $(DOLBY_PATH)/proprietary/vendor/lib/libaualgo_sst_component.so:$(TARGET_COPY_OUT_VENDOR)/lib/libaualgo_sst_component.so \
    $(DOLBY_PATH)/proprietary/vendor/lib/libstagefright_foundation.so:$(TARGET_COPY_OUT_VENDOR)/lib/libstagefright_foundation.so \
    $(DOLBY_PATH)/proprietary/vendor/lib/soundfx/libmsstwrapper.so:$(TARGET_COPY_OUT_VENDOR)/lib/soundfx/libmsstwrapper.so \
    $(DOLBY_PATH)/proprietary/vendor/lib64/libaualgo_foundation.so:$(TARGET_COPY_OUT_VENDOR)/lib64/libaualgo_foundation.so \
